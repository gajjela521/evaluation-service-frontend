...
import { canAccessSystem, getApprovalMessage } from '@/utils/approval';
...
export const BookExamPage = () => {
  ...
  const approvalMessage = getApprovalMessage(user);
            ...
            {selectedSlotId && (
              <div className="bg-white rounded-lg shadow-md p-6">
                <button
                  ...
                  disabled={bookingMutation.isPending || !isApproved}
                ...
                >
                  {!isApproved ? 'Approval Required' : bookingMutation.isPending ? 'Booking...' : 'Confirm Booking'}
                </button>
                {!isApproved && (
                  <p className="mt-2 text-sm text-center text-gray-600">
                    You need admin approval to book exams
                  </p>
                )}
              </div>
            )}
